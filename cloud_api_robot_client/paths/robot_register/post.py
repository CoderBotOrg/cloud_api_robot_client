...
# body param
SchemaForRequestBodyApplicationJson = RobotRegisterData


request_body_robot_register_data = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = RobotCredentials
...
class BaseApi(api_client.Api):
    ...
    def _register_robot_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_robot_register_data.serialize(body, content_type)
...
class RegisterRobot(BaseApi):
    ...
    def register_robot(
        ...
        return self._register_robot_oapg(
            body=body,
